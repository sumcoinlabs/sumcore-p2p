 ...
 * @returns {Inventory} - A new instance of Inventory
 */
Inventory.forBlock = function(hash, fWitness = false) {
  var type = fWitness ? Inventory.TYPE.WITNESS_BLOCK : Inventory.TYPE.BLOCK;
  return Inventory.forItem(type, hash);
};
 ...
 * @returns {Inventory} - A new instance of Inventory
 */
Inventory.forFilteredBlock = function(hash, fWitness = false) {
  var type = fWitness ? Inventory.TYPE.FILTERED_WITNESS_BLOCK : Inventory.TYPE.FILTERED_BLOCK;
  return Inventory.forItem(type, hash);
};
 ...
 * @returns {Inventory} - A new instance of Inventory
 */
Inventory.forTransaction = function(hash, fWitness = false) {
  var type = fWitness ? Inventory.TYPE.WITNESS_TX : Inventory.TYPE.TX;
  return Inventory.forItem(type, hash);
};
...
Inventory.TYPE.WITNESS_BLOCK = Inventory.TYPE.BLOCK | Inventory.WITNESS_FLAG;
Inventory.TYPE.WITNESS_TX = Inventory.TYPE.TX | Inventory.WITNESS_FLAG;
Inventory.TYPE.FILTERED_WITNESS_BLOCK = Inventory.TYPE.FILTERED_BLOCK | Inventory.WITNESS_FLAG;
Inventory.TYPE_NAME = [
  'ERROR',
  'TX',
  'BLOCK',
